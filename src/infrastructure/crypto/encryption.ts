...
/**
 * RGPD Export Encryption (AES-256-GCM)
 *
 ...
 * @param password - Encryption password (user-provided or generated)
 ...
 *
 * @returns Random password (32 bytes, base64-encoded)
 */
export function generateExportPassword(): string {
