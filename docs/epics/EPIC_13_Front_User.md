...
|-----------|-------------|---------------|
| **Framework** | Next.js 16.1+ App Router | SSR pour SEO, React 19 + React Compiler, cohérence plateforme |
| **Auth** | NextAuth.js v5 | Session management, intégration native |
| **UI Library** | shadcn/ui (Radix UI + Tailwind) | Composants accessibles, React 19 compatible, cohérence design |
